    ...
    <>
      <section id="singleVilla" className="page">
        <div className="container">
          ...
          <p>
            {filteredVilla.bathrooms} غرف / {filteredVilla.guests} ضيوف /{" "}
            {filteredVilla.bathrooms} مطابق / {filteredVilla.squareMeter}{" "}
            المنطقه
          </p>
          <div className="checkin_out">
            <h5>
            من تاريخ: <span> 9:00 AM</span>
            </h5>
            <h5>
              الي تاريخ <span> 11:00 PM</span>
            </h5>
          </div>
